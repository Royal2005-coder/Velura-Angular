/**
 * PostgREST select list for `chat_session` rows, including the support-ticket embed.
 */
...
/**
 * PostgREST select list for `chat_message` rows.
 */
...
/**
 * PostgREST select list for chat product cards, including category and variants.
 */
...
/**
 * Role codes allowed to list and reply on chatbot handoff sessions.
 */
export const CHAT_SUPPORT_ROLES: readonly string[] = [
  "super_admin",
  "admin_operator_cskh_dt"
];

/**
 * First assistant message written when a chat session is created.
 */
